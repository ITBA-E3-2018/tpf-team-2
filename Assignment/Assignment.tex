...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{\string"Images/VGA pins\string".png} 
\par\end{centering}
\caption{VGA Pins}
\label{1}
\end{figure}
...
\includegraphics[scale=0.4]{\string"Images/Simulacion 1\string".png}
\par\end{centering}
\noindent \begin{centering}
\includegraphics[scale=0.4]{\string"Images/Simulacion 2\string".png}
\par\end{centering}
